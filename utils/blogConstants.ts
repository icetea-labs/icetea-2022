...
export const blogs: Array<BlogTypes> = [
  ...
  },
  {
    ...
    date: "Mon 12/05/2022",
    image: "/images/news/icetea_monthly_report.jpg",
    hashtags: [],
    short_intro: "",
    intro:
      "Take a look at the main milestones and overall development of Icetea Labs ecosystem’s projects (Firebird, GameFi.org, Red Kite, DESports.gg, and Metaforce) this November!",
    html: true,
    content: [
      "<p>Dear community,</p>",
      "<p>Below is the report for this November, which includes the main milestones of Icetea Labs ecosystem&rsquo;s projects (Firebird, GameFi.org, Red Kite, DESports.gg, and Metaforce) in 01 month.</p>",
      "<p>We not only keep performance the best but also constantly find the breaking point to develop the projects in particular and the whole ecosystem in general.</p>",
      "<p>Let&rsquo;s check it out and have an overview of the Icetea Labs ecosystem!</p>",
      "<p><br/></p>",
      '<p><img src="/images/news/table_of_products.jpg" width="100%" ></p>',
      "<p><br/></p>",
      "<h3>IFO/ ILAP</h3>",
      "<p>A platform that engaged fans and real players.</p>",
      "<p>A new initiative - Initial Fan Offering (IFO) has been released that helps the project to acquire a high-quality community and true fans over a long period.&nbsp;</p>",
      "<p>Besides, Icetea Labs Accelerator Program (ILAP) has successfully run for 08 weeks.&nbsp;</p>",
      "<p>Now, let&rsquo;s reflect on some beautiful moments with IFO and ILAP.</p>",
      "<p><br/></p>",
      '<p><img src="/images/news/ifo_ilap.jpg" width="100%" ></p>',
      "<p><br/></p>",
      "<h3>GAMEFI.ORG</h3>",
      "<p>An all-in-one discovery hub for web3 games and metaverses.</p>",
      "<p><br/></p>",
      '<p><img src="/images/news/gamefi_plans.jpg" width="100%" ></p>',
      "<p><br/></p>",
      "<ol>",
      "<li>",
      ...
      "</li>",
      "</ol>",
      "<p>A series of events on GameFi.org has been operated smoothly with great attention from the community.&nbsp;</p>",
      "<p>GameFi.org and Binance NFT were the co-hosting for Dvison World&rsquo;s Land Box sale&nbsp;(Dvision World is a metaverse platform based on the combination of Dvision network blockchain, NFT, and VR technology), and time for unboxing successfully took place last month. &nbsp;</p>",
      "<p>GameFi.org and ShopNEXT co-worked to run an airdrop worth $50.000 exclusively for the GameFi.org community.</p>",
      "<p>Besides, Cyber Arena extended the whitelisting time on GameFi.org.</p>",
      "<p>Another update was that the new pool on GameFi Party was opened with the name &ldquo;Play and Earn&rdquo;.</p>",
      '<ol start="2">',
      "<li>",
      "<p>Ecosystem Partners</p>",
      "</li>",
      "</ol>",
      "<p>GameFi.org established cooperation with two new partners: Firebird and Cyber Arena.</p>",
      "<p>With the aim to diversify the user experience and bring more convenience to the current Coinbase wallet users, GameFi.org decided to support the Counbase Wallet on GameFi.org&rsquo;s platform.&nbsp;</p>",
      "<p>In addition, GameFi.org was one of&nbsp;the first launchpads&nbsp;that integrate the Aptos blockchain and supported projects launching IGO on that network.</p>",
      '<ol start="3">',
      "<li>",
      "<p>Technical Progress</p>",
      "</li>",
      "</ol>",
      "<p>The dev team has constantly developed and released new features. The Digital Collectibles - the advanced virtual plaza of Web3 digital assets was public in November 2022. It worked like an NFT marketplace, with upgraded and advanced functions for people to come to explore, collect and transfer Web3 digital assets in the form of NFTs.</p>",
      "<p>GameFi.org also successfully launched the GameFi Party where users could play games and easily win rewards.&nbsp;</p>",
      "<p><br/></p>",
      "<h3>FIREBIRD</h3>",
      "<p>A user-friendly and high-performance layer 1 EVM blockchain dedicated to NFT &amp; Web3 games.&nbsp;</p>",
      "<p><br/></p>",
      '<p><img src="/images/news/phoenix_cup.jpg" width="100%"></p>',
      "<p><br/></p>",
      "<ol>",
      "<li>",
      "<p>Events and Updates</p>",
      "</li>",
      "</ol>",
      "<p>After a long time hard-working, the Firebird team successfully released the first public testnet named Phoenix Cup for the community to test and experience. &nbsp;</p>",
      "<p>This testnet version has been public from November 20 to December 18, 2022. Just 01 week from officially opening, the Phoenix Cup has totally gained up to 600.000 transactions, which means about 75.000 transactions are made per day. Simultaneously, the number of wallet addresses recorded by the system has reached 20.000.</p>",
      "<p>Phoenix Cup has been still going on with active support from the community, which is evidenced by the very positive recorded numbers.</p>",
      "<p>Besides the main events, Firebird also had other activities to warm up the community, for example, the &ldquo;Fly with Firebird&rdquo; minigame, etc.</p>",
      '<ol start="2">',
      "<li>",
      "<p>Ecosystem Partners</p>",
      "</li>",
      "</ol>",
      "<p>One of the essential points for the development of a project is to expand the cooperation with the key partners. In this phase of testnet, Firebird welcomed a couple of new partners: Monsterra, GameFi.org, Mirai Studio, Metaforce, and Red Kite. &nbsp;</p>",
      "<p><br/></p>",
      "<h3>DESPORTS.GG</h3>",
      "<p>A decentralized eSports platform elevating the gaming scene for Web2 gamers to a whole new level - Web3 gaming.</p>",
      "<p><br/></p>",
      '<p><img src="/images/news/desports_established.jpg" width="100%"></p>',
      "<p><br/></p>",
      "<ol>",
      "<li>",
      "<p>Events and Updates</p>",
      "</li>",
      "</ol>",
      "<p>DESports.gg is so delighted to inform you that DESports.gg is closing the deal to become the official platform and web portal for SEA Games and pre-SEA Games 2023.</p>",
      "<p>03 tournaments were organized last month: DESports PUBG Open Cup 1, PUBG Open Cup 2, and Valorant Open Cup 1 with the participation of 64 teams, 64 teams, and 32 teams respectively.</p>",
      '<ol start="2">',
      "<li>",
      "<p>Ecosystem Partners</p>",
      "</li>",
      "</ol>",
      "<p>Foresee the potential development, Bold Ventures invested $50.000 and became the strategic partner of DESport.gg.&nbsp;</p>",
      "<p>Additionally, Victory Point also officially announced the partnership with DESport.gg this month.&nbsp;</p>",
      '<ol start="3">',
      "<li>",
      "<p>Technical Progress</p>",
      "</li>",
      "</ol>",
      "<p>A new game was released in the DESports.gg ladder to serve the users&rsquo; demand: Dota 2.&nbsp;</p>",
      "<p>In order for the users to have diverse experience, the DESports.gg team also published 02 new formats supported in the Tournament: Double Elimination&nbsp;(A type of elimination tournament competition in which a participant ceases to be eligible to win the tournament&rsquo;s championship upon having lost two games or matches)&nbsp;and Round Robin&nbsp;(A type of tournament in which each contestant meets every other participant, usually in turn).</p>",
      "<p><br/></p>",
      "<h3>METAFORCE</h3>",
      "<p>The first Web3 gaming on-demand, work-to-earn protocol that exists to build a symbiotic relationship between players, games, and clans in the ecosystem.&nbsp;</p>",
      "<p><br/></p>",
      '<p><img src="/images/news/metaforce_start.jpg" width="100%"></p>',
      "<p><br/></p>",
      "<ol>",
      "<li>",
      "<p>Events and Updates</p>",
      "</li>",
      "</ol>",
      "<p>IFO hosted two of their AMAs with Metaforce. The first AMA took place on October 25 while the second one - in collaboration with Metamoonshots - took place on November 08, 2022.</p>",
      "<p>Be UNITE be CHAMPIONS, a special event co-hosted by Metaforce, beFITTER, and Red Kite, was launched from November 14 to November 21, 2022. The giveaway event was an opportunity to incentivize users to lead a healthier lifestyle while earning.&nbsp;</p>",
      '<ol start="2">',
      "<li>",
      "<p>Ecosystem Partners</p>",
      "</li>",
      "</ol>",
      "<p>In November, Metaforce welcomed 04 new partners: IFO, beFITTER, Red Kite, and Firebird.&nbsp;</p>",
      "<p><br/></p>",
      "<h3>RED KITE</h3>",
      "<p>A cutting-edge launchpad and some DeFi/NFTFi features.</p>",
      "<p><br/></p>",
      '<p><img src="/images/news/redkite_forcusses.jpg" width="100%"></p>',
      "<p><br/></p>",
      "<ol>",
      "<li>",
      "<p>Events and Updates</p>",
      "</li>",
      "</ol>",
      "<p>Red Kite successfully organized 02 minigames &ldquo;Confetti&rdquo; to warm up the community.&nbsp;</p>",
      "<p>03 airdrop events from WinGoal, ShopNEXT, beFITTER x Metaforce were conducted with the participation of a large number of users. Likewise, The giveaway of ShopNEXT with the total rewards of up to 300 NFT card cases Level 01 for the Red Kite community attracted more than 6.700 participants.</p>",
      "<p>MetaBeat: $BEAT held its IDO on Red Kite with a total allocation of $150.000 and successfully listed this month.</p>",
      '<ol start="2">',
      "<li>",
      "<p>Ecosystem Partners</p>",
      "</li>",
      "</ol>",
      "<p>Like GameFi.org, Red Kite became one of the first launchpads to support and integrate the Aptos chain.</p>"
    ],
    link: [],
    tags: ["Accelerator", "Web3"],
    show: true,
  ...
  },
  {
    ...
    date: "Tue 11/29/2022",
    image: "/images/news/taik_ki_speaker.jpg",
    hashtags: [],
    short_intro: "",
    intro: "",
    html: true,
    content: [
      "<p>In this episode, we are glad to have Taik Ki (BlackCrunch) Yeo&nbsp;- CMO of Yooldo | Trouble Punk, and Hayang - Business Operation Lead of Yooldo | Trouble Punk join us to share more about the project.&nbsp;</p>",
      "<p>Yooldo is an X-to-Earn game content platform that will have tokenomics optimized for the content provided by each game, and the form of Earn also varies from game to game. Trouble Punk | Cyber Galz, the first game on the Yooldo platform, is a fighting action game of the battle royale genre. Sharing the short-term plan for the next 03 months,&nbsp;Taik Ki (BlackCrunch) Yeo said, &quot;We are currently updating more characters and more maps within the game. We first had the Closed Beta Test a few months ago and got a lot of analytics and surveys from there. We have already fixed the bugs and issues in the first Beta test version. Additionally, we&rsquo;ll get more game modes and more enjoyment that users can play around with when the second Closed Beta Test releases. In the next three months, there will be a second Closed Beta version, and this second one will also open as well&rdquo;.</p>",
      "<p>When being asked&nbsp;what impressed them the most when being a part of ILAP,&nbsp;&nbsp;Taik Ki (BlackCrunch) Yeo shared that&nbsp;&ldquo;The most amazing thing is that not only the mentors but also the speakers are really insightful with so many ideas they give from their experience in the past. They have already built successful products, and they have been in the market for several years. I have received a lot of helpful information and insights from them when building our product&rdquo;. Simultaneously, from Haya&rsquo;s point of view, &nbsp;&ldquo;I think this program is like a shark tank in the Web3 ecosystem. In addition to getting insights from mentors and speakers as BC mentioned, we also get a lot of support that could develop our projects like the technical AWS support or other exclusive packages from other ILAP partners. It gonna be a great help for the project builder in both the long term and short term as well. Therefore, I think the ILAP program understands what Web3 Startups want and how to support Web3 projects better. This really the most thing that impresses me a lot&rdquo;.</p>",
      "<p>Check the audio to find out more interesting sharing from the representatives from Yooldo | Trouble Punk:</p>",
      "<p><br/></p>",
      '<p><iframe width="100%" height="450" src="https://www.youtube.com/embed/IrOfOwXDLRk" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></p>',
      "<p><br/></p>",
      '<p>Follow&nbsp;<a href="https://twitter.com/Icetea_Labs">Icetea Labs Twitter</a> and our&nbsp;<a href="https://t.me/ILAP_Announcement">Telegram official channel</a> to get the latest updates!</p>'
    ],
    link: [],
    tags: ["Accelerator", "Web3"],
    show: true,
  ...
  },
  {
    ...
    date: "Mon 11/28/2022",
    image: "/images/news/official_announcement.jpg",
    hashtags: [],
    short_intro:
      "We will randomly select 10 lucky projects from the projects applying to ILAP Cyber Monday Grants to receive grants from our supportive partners: Amazon Web Services (AWS), GameFi.org, NodeReal, Miracle Block, DESports.gg, and Metaforce.",
    intro: "",
    html: true,
    content: [
      "<p>On the occasion of Cyber Monday, we are glad to open ILAP Cyber Monday Grants as special support for all the Web3 projects in ILAP. This program is open to all the Web3 projects that applied to ILAP and haven&apos;t received ILAP partner&apos;s grants before. We will randomly select 10 lucky projects from the projects applying to ILAP Cyber Monday Grants to receive grants from our supportive partners: Amazon Web Services (AWS), GameFi.org, NodeReal, Miracle Block, DESports, and Metaforce.</p>",
      "<p><br/></p>",
      "<p>I. TOTAL BENEFITS&nbsp;</p>",
      "<p>Total benefits up to $100.000&nbsp;</p>",
      "<p>Total slot: 10 Web3 projects</p>",
      "<p>10 lucky Web3 projects will be selected to receive special grants from ILAP partners Amazon Web Services (AWS), GameFi.org, NodeReal, Miracle Block, DESports, and Metaforce.</p>",
      "<p><br/></p>",
      '<p><img src="/images/news/top_benefits.jpg" width="100%" /></p>',
      "<p><br/></p>",
      "<p>+ AWS: $5000 AWS Credits (AWS Activate program: https://aws.amazon.com/activate/)</p>",
      "<p>T&amp;C: Each Web3 startup&apos;s credits eligibility in the Activate program will be subject to its history of credits with AWS</p>",
      '<p>+ NodeReal: Up to 35% discount on Growth Pl<a href="http://gamefi.org/">an.</a></p>',
      '<p><a href="http://gamefi.org/">+&nbsp;Game</a>Fi.org: Up to 20% discount on Player Attraction + Marketing Package</p>',
      "<p>+ Miracle Block (Eco Ticket): 1 Free Ticket and 1 Ticket 50% discount&nbsp;</p>",
      '<p>+ Metaforce: $2000 Treasure Hunt Event Credit for To<a href="http://desports.gg/">p 10</a></p>',
      '<p><a href="http://desports.gg/">+&nbsp;DEs</a>port.gg: Essential Package: $2000 *For a game with testnet*&nbsp;</p>',
      "<p><br/></p>",
      "<p>II. KEY MILESTONES</p>",
      "<p>The ILAP Cyber Monday Grants will officially start from 10:00 UTC AM on November 28 to 10:00 UTC AM on December 08, 2022.</p>",
      "<p><br/></p>",
      "<p>III. GUIDELINES TO APPLY ILAP CYBER MONDAY GRANTS</p>",
      "<p><br/></p>",
      '<p><img src="/images/news/application_guidelines.jpg" width="100%" /></p>',
      "<p><br/></p>",
      "<p>All the ILAP applicants who want to apply to ILAP Cyber Monday Grants just need to complete some simple steps below:</p>",
      '<p>Step 01: Sign up/ Sign in to <a href="https://metaforce.org/">metaforce.org</a> with the referral code &ldquo;ILAPCYBER&rdquo;</p>',
      "<p>Step 02: Click the &quot;Events&quot; section and find the &quot;ILAP MONDAY CYBER GRANTS&quot; event&nbsp;</p>",
      "<p>Step 03: Click on the event and complete all the event tasks&nbsp;</p>",
      '<p>Or sign in/ sign up and complete all the tasks at this link: <a href="https://metaforce.org/event/ilap-mini-event-2d9388569d">https://metaforce.org/event/ilap-mini-event-2d9388569d</a></p>',
      "<p>Remember that your application is only eligible once you have entered the exclusive referral code and completed all the tasks! Take your turn and be the lucky one!</p>"
    ],
    link: [],
    tags: ["Accelerator", "Web3"],
    show: true,
  ...
  },
  {
    ...
    date: "Fri 11/18/2022",
    image: "/images/news/hasbon_speaker.jpg",
    hashtags: [],
    short_intro: "",
    intro: "",
    html: true,
    content: [
      "<p>Coming to ILAP&apos;s Startup Story: 15 minutes sharing session, we are pleased to have three representatives from Hashbon Pass join with us: Yuri Golosovker - COO, Andrey Svininnikov - Head of Business and Daniil Inasov - Business Development Facilitator. They are confident that their product is the world&apos;s first anonymous KYC.</p>",
      '<p>Daniil - Business development of Hashbon Pass shared the vision of the project &ldquo;In terms o"<p>f potential, one of the big things we are hoping has been passed and it&rsquo;s the standard for online KYC verification&rdquo;, &ldquo;Government regulations will obligate us to have KYC and AML and it&rsquo;s going to be a must and we are one of those solutions that aggregate current KYC solution&rdquo;.</p>',
      "<p>He also suggested this project&apos;s community-building strategy. It was thought that the community came after the product. However, over time, they realized that they needed to show the community what they were doing, and how their products got better day by day. Community is the most important thing to all the projects.</p>",
      "<p>The representative had explored the Icetea Labs Accelerator Program on LinkedIn and decided to join when he saw ILAP mentors. &ldquo;ILAP has been on board many best advisors that help with knowing who you are and what you do&rdquo;, &ldquo;The biggest expectation we have is to have a mass adoption because if all of the projects become easier to use and concentrate on community, more people will come to Web3&rdquo; - Daniil said.</p>",
      "<p>Check the audio to know more interesting things about Hashbon Pass - the top 06 projects in ILAP.&nbsp;</p>",
      "<p><br/></p>",
      '<iframe width="100%" height="450" src="https://www.youtube.com/embed/rTC3pC7cL7U" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>',
      "<p><br/></p>",
      "<p>Also, don&rsquo;t miss the next episode of Startup Story: 15 minutes with ILAP top projects. See you!</p>",
      '<p>Follow <a href="https://twitter.com/Icetea_Labs">Icetea Labs Twitter</a> and our <a href="https://t.me/ILAP_Announcement">Telegram official channel</a> to get the latest updates!</p>'
    ],
    link: [],
    tags: ["Accelerator", "Web3"],
  ...
  },
  {
    ...
    date: "Wed 11/09/2022",
    image: "/images/news/teddy_phan_speak.jpg",
    hashtags: [],
    short_intro: "",
    intro: "",
    html: true,
    content: [
      "<p>Eternal Glory is backed by IEC - one of the Top 07 Game Studios in South East Asia, with 600M+ downloads worldwide. Teddy Phan - the CEO of Eternal Glory, also a member of the founding team of IEC game studio, shares 03 strong points that made a successful strategy of IEC game studio - their first startup: &ldquo;The first point is marketing, we run the campaign for the mass users from US, Europe, and Asia. The second one is the deep experience in analyzing our data users in the customers&rsquo; behavior. And last but not least we are very strong in monetization, which makes users can play more and spend more in the game&rdquo;.&nbsp;</p>",
      "<p>For Eternal Glory, with an effective marketing strategy, the number of users increased by more than 30 percent in just 02 months, successfully achieving more than 30.000 users in Telegram, Discord, and Twitter. &nbsp;</p>",
      "<p>Sharing his experience in overcoming the market crisis, besides being confident in the knowledge, he also added &ldquo;If you want to run a long-term project, you have to go every time, whether it&rsquo;s summer or winter. We started our project in winter, passed, survived, and kept going. We think when the market is better, we will grow faster.&rdquo; &nbsp;</p>",
      "<p>Teddy Phan also shared with us the hardest decision he made while building the Eternal Glory project and many other interesting stories, check the podcast to catch up more!</p>",
      "<p><br/></p>",
      '<iframe width="100%" height="450" src="https://www.youtube.com/embed/_FaEzbxiiCI" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>',
      "<p><br/></p>",
      '<p>Don&rsquo;t forget to follow <a href="https://twitter.com/Icetea_Labs">Icetea Labs Twitter</a> and our <a href="https://t.me/ILAP_Announcement">Telegram official channel</a> to get the latest updates about our program!</p>'
    ],
    link: [],
    tags: ["Accelerator", "Web3"],
    show: true,
  ...
  },
  {
    ...
    date: "Mon 11/07/2022",
    image: "/images/news/ecosystem_report.jpg",
    hashtags: [],
    short_intro: "",
    intro: "",
    html: true,
    content: [
      "<p>Dear readers,</p>",
      "<p>We write this report for our team - to recognize the incredible job our team completed in October and to summarize the Icetea Labs ecosystem milestones for any new users.</p>",
      "<p>We write it for ourselves to organize our monkey mind and create an overview for non-crypto users to get to know the best available index in the Icetea Labs ecosystem.</p>",
      "<p>Most importantly, we are writing to you as well. We make an effort to give our overview to everyone who will benefit from it, whether you&apos;re a crypto beginner or one of our multi-cycle customers.</p>",
      "<p>Let&apos;s dive in</p>",
      "<p><br/></p>",
      '<p><h3 style="font-weight: bold">ICETEA LABS ACCELERATOR PROGRAM&nbsp;</h3></p>',
      "<p>An 08-week accelerator program that helps Web3 Startups in building a product-market fit and expanding, and growth. This journey is specially designed for potential startups that already have MVPs for Web3 applications, especially in GameFi, NFT, or Metaverse.</p>",
      "<p><br/></p>",
      '<p><img src="/images/news/ecosystem_report_detail_2.jpg" width="100%"></p>',
      "<p><br/></p>",
      "<ol>",
      "<li>",
      "<p>Events and Updates</p>",
      "</li>",
      "</ol>",
      "<p>Last month, a series of ILAP workshops were organized with experts on specific topics. The first workshop took place with the participants of Joseph Young from Hashed, Boburjon Muydinov (Brian) from Dvision Network, and representatives from Top6. Another workshop was hosted by Hatu - The cofounder of DAO Maker to discuss his perspective on tokenomics.&nbsp;</p>",
      "<p>The special other activity was Tea Talk #1: Tell us your Web3 story, a cozy meeting to allow Top06 Finalists to build deeper bonds with the organizers, workshop mentors, and partners.</p>",
      "<p>One of our newest initiatives IFO - Initial Fan Offering was released to the Icetea Labs community, you would become a true fan of our ecosystem, provide active contributions to its powered/ incubated projects and earn valuable tokens in return.</p>",
      '<ol start="2">',
      "<li>",
      "<p>Ecosystem Partners&nbsp;</p>",
      "</li>",
      "</ol>",
      "<p>In October, ILAP ecosystem partners reached a total of 57 well-known businesses. They are big technology corporations, international venture capitals, and &quot;pedestals&quot; for many successful companies in the market. Some prominent names can be mentioned such as AlphaVentureDAO, Kucoin Labs, Polygon, YGGSea, Avocado Dao, Dvision network, Nodereal, AWS, and so on.</p>",
      "<p><br>On October 7th, 2022, Icetea Labs together with Symbolic Capital, LedgerPrime, Hashed and &nbsp;Polygon Ventures hosted the Private Cocktail Night in Hanoi, Vietnam, with 100+ C-level participants &nbsp; from big names such as Kyber, Houbi, AWS, etc. .</p>",
      "<p><br/></p>",
      '<p><h3 style="font-weight: bold">FIREBIRD</h3></p>',
      "<p>A game-dedicated web2-friendly high-performance blockchain.</p>",
      "<p><br/></p>",
      '<p><img src="/images/news/ecosystem_report_detail_3.jpg" width="100%"></p>',
      "<p><br/></p>",
      "<ol>",
      "<li>",
      "<p>Events and Updates</p>",
      "</li>",
      "</ol>",
      "<p>PolkaFoundry Rebrands as Firebird - Cosmos-based game-dedicated L1 blockchain with an emphasis on UX-enabling features to eliminate web3 barriers for web2 users.</p>",
      '<p>Icetea Labs, Parent Corporation to Firebird (formerly known as PolkaFoundry), commenced building the Layer-1 blockchain more than 3 years ago. Despite struggling time finding a niche in the market in the first place, with the possession of several blockchain&rsquo;s valuable ideas, Icetea Labs has transformed into top Web3 gaming and metaverse incubator in SEA that is also operating&nbsp;<a href="http://gamefi.org/">GameFi.org</a>,&nbsp;<a href="https://redkite.polkafoundry.com/#/">Red Kite launchpad</a>,&nbsp;<a href="https://ilap.icetea.io/">ILAP</a>,&nbsp;<a href="https://www.desports.gg/">DESports</a>,&nbsp;<a href="https://metaforce.org/">Metaforce</a>, etc.</p>',
      "<p>Firebird released the Testnet campaign from October 16th to November 3rd, and the Mainnet is projected to be released in December 2022.</p>",
      "<p>The first task of Firebird after completing rebranding: Firebird has onboarded &nbsp;exclusive partners deploying for this campaign, including &nbsp;F2Game, Gunstar, Wanaka Farm, Evermoon, My Master War, and Monsterra.&nbsp;</p>",
      "<p>The governance token ($PKF) remains unchanged and plays an increasingly vital role in Firebird&rsquo;s ecosystem, this aims to increase the chance the token price can corner the market and can increase gross volume and revenue stream. .&nbsp;</p>",
      '<ol start="2">',
      "<li>",
      "<p>Community</p>",
      "</li>",
      "</ol>",
      "<p>Firebird network successfully organized a quiz game that attracted more than 10k users joining. The event was successfully concluded on October 14th, 2022.&nbsp;</p>",
      "<p><br/></p>",
      '<p><h3 style="font-weight: bold">GAMEFI.ORG</h3></p>',
      "<p>An all-in-one discovery hub for web3 games and metaverses.</p>",
      "<p><br/></p>",
      '<p><img src="/images/news/ecosystem_report_detail_4.jpg" width="100%"></p>',
      "<p><br/></p>",
      "<ol>",
      "<li>",
      "<p>Events and Updates</p>",
      "</li>",
      "</ol>",
      "<p>Let&rsquo;s start with the breakout event of GameFi this year:&nbsp;Catventure</p>",
      "<p>Gamefi successfully organized of Birthday Event. This very first web3 gaming event aims to boost branding awareness and acquire new users for games and projects and brings players a captivating, thrilling, and diverse experience of multiple gameplays.</p>",
      "<p>The event has reached more than&nbsp;6.5 million impressions&nbsp;and followers across platforms and more than&nbsp;12k real players&nbsp;are immersed in the appealing gameplay with more than&nbsp;100 partners.&nbsp;GameFi.org poured more than&nbsp;$70,000&nbsp;into this event. The top&nbsp;500 players&nbsp;with the highest Gafish were rewarded with a precious prize.&nbsp;</p>",
      '<ol start="2">',
      "<li>",
      "<p>Partners and Community updates:&nbsp;</p>",
      "</li>",
      "</ol>",
      "<p>At present,&nbsp;GameFi.org&nbsp;has established contact with&nbsp;Dvision Network&nbsp;and has officially launched&nbsp;Land Box Sale.&nbsp;GameFi.org&nbsp;also formed Strategic Partner with&nbsp;ILAP&nbsp;and was the first initiative to step into&nbsp;IFO (Initial Fan Offering)&nbsp;of Icetea Labs Accelerator Program.&nbsp;</p>",
      '<p><a href="http://gamefi.org/">GameFi.org</a> team expands the topics to be discussed in the group. Not only<a href="http://gamefi.org/">&nbsp;GameFi.org</a> issues or projects launched on<a href="http://gamefi.org/">&nbsp;GameFi.org</a> but users can discuss all blockchain game projects, fun talks, trade talks, photos, memes, and related topics in the Telegram Chat group.</p>',
      '<p><a href="http://gamefi.org/">GameFi.org</a> Insight is to be released to update the latest news about crypto, games, and the metaverse. Users can access, read, share, and discuss in the Telegram Chat group.</p>',
      '<ol start="3">',
      "<li>",
      "<p>Technical progress</p>",
      "</li>",
      "</ol>",
      "<p><br/></p>",
      '<p><img src="/images/news/gamefi_report.jpg" width="100%"></p>',
      "<p><br/></p>",
      "<p>DappRadar estimated an NFT market cap of $14 billion in early September, a number that has risen since. Given the design space that NFTs have opened up for the entire crypto user economy, the long-term size and scope of this segment are scary big. We&rsquo;ll see 10% of crypto ($225B today) in the NFT market cap. We don&rsquo;t think they are off, but that may speak more to the opportunity for NFT creators and infrastructure builders than it does to the inevitability of most specific NFT projects.</p>",
      "<p>The &ldquo;real world&rdquo; version of an NFT might be something like the deed to your house (verifiably scarce) or you could grant access to the house for Airbnb guests with the NFT (programmable), or you could take out a home equity line of credit and pledge the NFT as collateral on a peer-to-peer lending platform (portable).</p>",
      "<p>That comes later. The&nbsp;GameFi NFT&nbsp;was released in late October.&nbsp;</p>",
      "<p><br/></p>",
      '<p><h3 style="font-weight: bold">RED KITE</h3></p>',
      "<p>A cutting-edge launchpad and some DeFi/NFTFi features.</p>",
      "<p><br/></p>",
      '<p><img src="/images/news/ecosystem_report_detail_6.jpg" width="100%"></p>',
      "<p><br/></p>",
      "<p>Red Kite&nbsp;using the same token as Firebird is a launchpad and NFTFI suite. The team has launched new staking pools for $PKF. The staking requirements and mechanisms are the same for the old and new staking pools, but the APR is different. The reason for this change is our platform will undergo a substantial update next month, promising potential and providing additional utilities for $PKF. As a result, the team decided to change APR values to align with the project&rsquo;s development path and improve the user experience.</p>",
      "<p>In light of the present market downturn, RedKite will establish new strategies to develop the project over the long term. Red Kite will concentrate on research, evaluation, and appraisal to identify in-depth, high-value, and profitable projects for the community rather than launching numerous projects. Although the number of IDO projects is likely to decrease during this period, they are working to improve our products and services for the greatest user experience. This month, Red Kite conducted 2 IDOs (MetaBeat &amp; PUMLx), 2 AMAs, 2 giveaway events</p>",
      "<p><br/></p>",
      '<p><h3 style="font-weight: bold">DESPORTS</h3></p>',
      "<p>DESports is a Decentralized eSports platform that will elevate the gaming scene for traditional gamers to a whole new level - Web3 Gaming. It is backed by Icetea Labs and 500 Bros Media, leading eSports organizers of Southeast Asia.</p>",
      "<p><br/></p>",
      '<p><img src="/images/news/ecosystem_report_detail.jpg" width="100%"></p>',
      "<p><br/></p>",
      "<ol>",
      "<li>",
      "<p>Events and Updates</p>",
      "</li>",
      "</ol>",
      "<p>This month, DESports has kicked off the series of DESports Open Cup. Only two tournaments in the PUBG Open Cup series, have attracted more than 100 PUBG semi-pro teams in Vietnam. More remarkably, over 1400+ participants joined the appreciation event after DESports PUBG SEA Invitational.&nbsp;</p>",
      '<ol start="2">',
      "<li>",
      "<p>Ecosystem Partners&nbsp;</p>",
      "</li>",
      "</ol>",
      "<p>DESports became an official partner of ILAP and provided special exclusive packages for Web3 Startups joining the program. A grant on DESports&apos; service package (Media, Livestream, PR) is offered to the top 30 projects in ILAP - Autumn 2022 Cohort with the details as below:</p>",
      "<p>💥 Top 06: USD 3.000 Grants&nbsp;</p>",
      "<p>💥 Top 15: USD 2.000 Grants&nbsp;</p>",
      "<p>💥 Top 30: USD 1.500 Grants</p>",
      "<p>Significantly, the top 06 selected projects in ILAP will receive exceptional cross-marketing support (Partnership activities, Early access to referral programs, and DESports fund), have the chance to appear in the list of NFT games introduced by DESports, and free deploy games on DESports Ladder &amp; Tournament.&nbsp;</p>",
      '<ol start="3">',
      "<li>",
      "<p>Technical progress</p>",
      "</li>",
      "</ol>",
      "<p>On October 9, DESports.gg officially debuted Ladder as a new feature and expanded the website&apos;s support for two additional languages (Vietnamese &amp; Thai). Besides, Ladder is also completed and launched.&nbsp;</p>",
      "<p><br/></p>",
      '<p><h3 style="font-weight: bold">METAFORCE</h3></p>',
      "<p>Metaforce is the first Web3 gaming on-demand, the work-to-earn protocol that exists to build a symbiotic relationship between players, games, and clans in the ecosystem.&nbsp;</p>",
      "<p><br/></p>",
      '<p><img src="/images/news/ecosystem_report_detail_5.jpg" width="100%"></p>',
      "<p><br/></p>",
      "<ol>",
      "<li>",
      "<p>Events and Updates</p>",
      "</li>",
      "</ol>",
      "<p>Metaforce officially launched Alpha Release on October 17th for exclusive partners with amazing new features.</p>",
      "<p><br/></p>",
      '<p><img src="/images/news/ecosystem_report_event.png" width="100%"></p>',
      "<p><br/></p>",
      '<ol start="2">',
      "<li>",
      "<p>Ecosystem Partners&nbsp;</p>",
      "</li>",
      "</ol>",
      "<p>In October, Metaforce welcomed Icetea Labs as the first lead backer. Icetea Labs has a tremendously experienced team with a litany of high-level roles throughout various first-tier companies. With the vast experience that Icetea Labs possesses, the support Metaforce can receive will be extremely helpful in focusing on developing its products. Icetea Labs will assist Metaforce in partnership development, tokenomics advisory, project marketing, and community expansion.&nbsp;</p>",
      '<ol start="3">',
      "<li>",
      "<p>Technical progress</p>",
      "</li>",
      "</ol>",
      "<p>💥Development version update: Metaforce Tasks</p>",
      "<p>💥Functional development: Multi-tenant Leaderboard</p>",
      "<p>💥Performance optimization: Content Platform</p>",
      "<p>💥Bugs fixed: Cross-marketing and Community-monitoring</p>",
      "<p><br/></p>",
      '<p><h3 style="font-weight: bold">CONCLUSION</h3></p>',
      "<p>October was an extremely volatile month for the market but also an active month for us. In the context that investment activities and cash flow are becoming scarce, we remain focused on building and developing our ecosystem with notable milestones such as the launch of Metaforce information, the implementation of events on DESports, or, more notably, the birthday event of GameFi.org with impressive numbers.</p>",
      "<p>November will be Icetea Labs&apos; birthday month, and hopefully, we&apos;ll celebrate it with even more remarkable achievements.</p>"
    ],
    link: [],
    tags: ["IceteaLab", "Ecosystem"],
    show: true,
    highlight: false
  },
  {
    ...
    date: "Wed 10/26/2022",
    image: "/images/news/julio_kotas_speak.jpg",
    hashtags: [],
    short_intro: "",
    intro: "",
    html: true,
    content: [
      "<p>Julio Kosta is proud to have a team with significant experience in the FPS field. Besides, a strength of Victory Point has a healthy and balanced economy designed in the game - which is the key to remain sustainable and long-run development of the project. He understands that in Web2, the gameplay is the key, but in Web3, gameplay and game economy are equally crucial.</p>",
      "<p>About the Icetea Labs Accelerator Program, Julio Kosta chose to join this cohort because of the reputation and the good name of Icetea Labs in this market. “We find some of the largest Web3 participants in ILAP such as Hashed, Protocol Labs, Saison Capital, Spark Capital, etc”. He also hopes to meet other Web3 builders on Demo Day at Miracle Block 2022 as he thinks they all have the same objective to bring the adoption to Web3, especially in Web3 gaming.</p>",
      "<p>Check the audio to know more interesting things about Victory Point - the top 06 projects in ILAP.</p>",
      "<p><br/></p>",
      '<p><iframe width="100%" height="450" src="https://www.youtube.com/embed/zwLFXcow3GE" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></p>',
      "<p><br/></p>",
      "<p>Victory Point currently has a strong user base with a high percentage of hard-core fans. Sharing about the achievement of a well-built community, Julio Kosta - the Co-Founder and CEO of Victory Point said that “We have a quick and short marketing campaign, priority on discord, from there we start growing our Twitter account and Telegram account, right now we have over 40,000 members across them”, “5,000 of them are more active and 1,000 to 2,000 of them are hard-core fans of Victory Point”.</p>",
      "<p>Also, don’t miss the next episode of Startup Story: 15 minutes with ILAP top projects. See you next week!</p>",
      '<p>Follow&nbsp;<a href="https://twitter.com/Icetea_Labs">Icetea Labs Twitter</a> and our&nbsp;<a href="https://t.me/ILAP_Announcement">Telegram official channel</a> to get the latest updates!</p>'
    ],
    link: [],
    tags: ["Accelerator", "Web3"],
  ...
  },
  {
    ...
    date: "FRI 02/17/2022",
    image: "/images/news/solice.png",
    hashtags: [],
    short_intro: "",
    html: true,
    intro:
      "The market is far beyond the gaming or blockchain communities, which can get easily onboarded from regular platforms like smartphones or laptops. Thus, a new metaverse utilizing the cutting edge technology of blockchain and giving the users an immersive experience within virtual reality (VR) is what makes Solice becomes one of the hottest projects recently.",
    content: [
